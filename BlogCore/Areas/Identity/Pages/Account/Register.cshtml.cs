...
namespace BlogCore.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            //campos personalizados, los mismos del modelo aplicationUser
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                //el metodo OnPostAsync es el que se encarga de guardar
                ...
                if (result.Succeeded)
                {
                    ...
                    //AQUI VALIDAMOS SI LOS ROLES SE EXISTEN SI NO SE CREAN
                    ...
                    //AQUI OBTENEMOS EL ROL SELECIONADO 
